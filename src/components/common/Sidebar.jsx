...
const Sidebar = ({ isOpen, setIsOpen, isAdmin = false }) => {
  ...
  const userNavigation = [
    ...
    { name: 'Make Prediction', path: '/dashboard/predict', icon: 'chart-bar' },
    { name: 'Prediction History', path: '/dashboard/history', icon: 'clock' },
    { name: 'My Profile', path: '/dashboard/profile', icon: 'user' },
  ];

  const adminNavigation = [
    { name: 'Admin Dashboard', path: '/admin', icon: 'template' },
    { name: 'Training Data', path: '/admin/training-data', icon: 'database' },
    { name: 'Model Management', path: '/admin/models', icon: 'cpu' },
